...
internal class VectorMemoryIndexer(
...
object MemoryIndexerFactory {
    fun create(textEmbedder: TextEmbedder, vectorStore: VectorStore): MemoryIndexer =
        VectorMemoryIndexer(textEmbedder, vectorStore)
}
