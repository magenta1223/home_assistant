...
/** Stores Slack message receipts and each member's active Codex session. */
interface SlackCodexSessionStore {
    ...
    /** Associates a claimed message with the Codex session that will answer it. */
    ...
    /** Creates and activates a new Codex session for a Slack principal. */
